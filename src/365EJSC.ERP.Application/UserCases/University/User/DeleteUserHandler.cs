...
{
    /// <summary>
    /// Handler for <see cref="DeleteUserRequest"/>
    /// </summary>
    public class DeleteUserHandler : IRequestHandler<DeleteUserRequest, Result<object>>
    {
        ...
        public async Task<Result<object>> Handle(DeleteUserRequest request, CancellationToken cancellationToken)
        {
