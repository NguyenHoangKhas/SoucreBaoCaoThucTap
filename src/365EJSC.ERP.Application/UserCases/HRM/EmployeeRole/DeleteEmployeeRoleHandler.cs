...
{
    public class DeleteEmployeeRoleHandler : IRequestHandler<DeleteEmployeeRoleRequest, Result<object>>
    {
        /// <summary>
        ...
        public DeleteEmployeeRoleHandler(IEmployeeRoleSqlRepository employeeRoleSqlRepository, ISqlUnitOfWork sqlUnitOfWork)
        {
        ...
        public async Task<Result<object>> Handle(DeleteEmployeeRoleRequest request, CancellationToken cancellationToken)
        {
            // Create validator and validate request
            DeleteEmployeeRoleValidator validator = new();
            ...
            Entities.EmployeeRole? employee = await employeeRoleSqlRepository.FindByIdAsync((int)request.Id, true, cancellationToken);
            ...
            try
            {
                ...
                employeeRoleSqlRepository.Remove(employee);
