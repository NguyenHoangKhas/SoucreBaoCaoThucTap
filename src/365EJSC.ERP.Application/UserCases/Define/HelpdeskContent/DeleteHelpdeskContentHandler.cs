...
{
    /// <summary>
    /// Handler for <see cref="DeleteHelpdeskContentRequest"/> 
    /// </summary>
    public class DeleteHelpdeskContentHandler : IRequestHandler<DeleteHelpdeskContentRequest, Result<object>>
    {
        ...
        /// <summary>
        /// Constructor of <see cref="DeleteHelpdeskContentHandler"/>, inject needed dependency
        /// </summary>
        public DeleteHelpdeskContentHandler(IHelpdeskContentSqlRepository helpdeskContentRepo, ISqlUnitOfWork unitOfWork)
        {
        ...
        /// <summary>
        /// Handle <see cref="DeleteHelpdeskContentRequest"/>, Delete the <see cref="Entity"/> base on data <see cref="DeleteHelpdeskContentRequest"/>
        ...
        public async Task<Result<object>> Handle(DeleteHelpdeskContentRequest request, CancellationToken cancellationToken)
        {
            // Create validator and validate request
            var validator = new DeleteHelpdeskContentValidator();
            ...
            try
            {
                // Marked HelpdeskContent as Delete state
                helpdeskContentRepo.Remove(helpdeskContent);
