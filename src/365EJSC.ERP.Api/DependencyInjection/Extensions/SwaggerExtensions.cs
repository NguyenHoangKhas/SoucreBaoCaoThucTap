...
namespace _365EJSC.ERP.Api.DependencyInjection.Extensions
{
    public static class SwaggerExtensions
    {
        ...
        public static IApplicationBuilder UseApiLayerSwagger(this IApplicationBuilder app)
        {
            ...
            var domainHosts = app.ApplicationServices.GetRequiredService<IOptions<DomainHostsDTOs>>().Value;
            var basePath = string.IsNullOrEmpty(domainHosts.BaseSwaggerURL) ? "" : domainHosts.BaseSwaggerURL;
